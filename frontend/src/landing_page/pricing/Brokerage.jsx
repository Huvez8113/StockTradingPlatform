      ...
      <div className="container mt-5">
        <div className="row mt-5 p-5 text-center border-top">
          <div className="col-8 p-4">
            ...
            <ul style={{textAlign:"left",lineHeight:"2.5", fontSize:"0.9rem"}} className="text-muted">
              <li>
          ...
          <div className="col-4 p-4">
            <a href="" style={{textDecoration:"none"}}><h3 className="fs-5 mb-4">List of Charges</h3></a>
          </div>
        </div>
      </div>
    </>
